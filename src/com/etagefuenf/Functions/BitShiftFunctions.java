package com.etagefuenf.Functions;
 ...
 */
public class BitShiftFunctions extends PApplet{
    ...
    public static int[] analyseColor(int Pixel){
        return new int[] {(Pixel >> 24) & 0xFF, (Pixel >> 16) & 0xFF, (Pixel >> 8) & 0xFF, Pixel & 0xFF};
    }
}
